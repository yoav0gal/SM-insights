...
def evaluate_gemini_sts(google_client, eval_dataset: Dataset):
    """
    ...
    df_with_embeddings1: pd.DataFrame = add_embeddings_to_dataframe(
        df_sentences1, google_client
    )
    df_with_embeddings2: pd.DataFrame = add_embeddings_to_dataframe(
        df_sentences2, google_client
    )
